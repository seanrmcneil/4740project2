...
def best_sense_entire_context(final_word,sentence,target_dictionary):
...
if __name__ == '__main__':
	...
	for word in data:
		...
		for sentence in data[word]:
			sense =best_sense_entire_context(final_word, sentence, target_dictionary) #Can change N here
			for item in sense:
				if item in scoring:
