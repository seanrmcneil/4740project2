...
def wordnet_to_reg(target_dictionary,context_definition):
	sentence_array = context_definition.split(" ")
	...
	for target_sense, target_definitions in target_dictionary.iteritems():
		...
		similar_words =  set(target_word_set).intersection(sentence_array)
...
>>>>>>> 08d1b668f4dda0c73a5d3d6b7aa8b59bc3888930
	...
	for word in data:
		...
		scoring = {}
		sense =best_sense_entire_context(final_word, data[word], target_dictionary, 5) #Can change N here
		for item in sense:
			if item in scoring:
